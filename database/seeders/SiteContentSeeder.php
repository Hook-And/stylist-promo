...
class SiteContentSeeder extends Seeder
{
    public function run(): void
    {
        $contents = [
            ...
            ['key' => 'purpose_text_2', 'value' => 'Я ответила на все ваши вопросы в одном гайде. В нем огромный выбор классных вещей, вы все найдете в нем что-то свое!', 'type' => 'text', 'section' => 'purpose', 'description' => 'Текст раздела'],
            ['key' => 'purpose_text_3', 'value' => 'В нем весь мой многолетний опыт, вся моя любовь к деталям и магия преображения — это ваш личный ключ к идеальному сезону.', 'type' => 'text', 'section' => 'purpose', 'description' => 'Текст раздела'],
            ...
            ['key' => 'purpose_item_3', 'value' => 'Узнать, где покупать стильные вещи.', 'type' => 'text', 'section' => 'purpose', 'description' => 'Пункт 3'],
            ['key' => 'purpose_item_4', 'value' => 'В рамках канала-гайда проконсультироваться со мной - расскажу, стоит ли вам брать ту или иную вещь и с чем ее носить', 'type' => 'text', 'section' => 'purpose', 'description' => 'Пункт 4'],
